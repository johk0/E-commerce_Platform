    ...
    return(
        <div className="grapper text-center pt-11 max-sm:px-6">
            ...
            <div className="cards pt-12 grid gap-y-9 grid-cols-[repeat(auto-fill,_minmax(300px,_1fr))] w-full">
                ...
                <p className="text-neutral-500 font-semibold w-4/6 m-auto">Enjoy quick and effortless purchases with our intuitive interface.</p>
                </div>
                <div className="card">
                ...
                <p className="text-neutral-500 font-semibold w-5/6 m-auto">Track your orders status from processing to delivery in real-time.</p>
                </div>
                <div className="card">
                ...
                <p className="text-neutral-500 font-semibold w-4/6 m-auto">Benefit from top-tier security measures protecting all your payment information</p>
                </div>
            </div>
        </div>
    )
