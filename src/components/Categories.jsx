...
function Categories() {
  ...
  <div className="categories w-4/5 flex justify-around flex-wrap m-auto py-7 mb-6 rounded-xl bg-white">
  {
    ...
    <div key={index} className='flex flex-col items-center'>
        <Link to={`/shop/${index}`}  className="image w-24 m-3 p-2 h-24 rounded-[50%] bg-slate-100 flex justify-center items-center hover:scale-[1.3] [transition:all_0.6s] cursor-pointer">
