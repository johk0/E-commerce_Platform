...
export default function Nav() {
    ...
    if (searchTerm.length > 0 && searchTerm.match(/^[a-zA-Z0-9\s]+$/)) {
    ...
    <>
      <header className="bg-white py-4 shadow-md px-5 max-md:hidden max-lg:px-4  sticky top-0 w-full z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <form className="ml-8 flex-grow text-center relative" onSubmit={handleSearchSubmit}  >
            <input
              type="text"
              placeholder="Search"
            ...
            >
              <Link  onClick={()=>{setSearchTerm("")}}  to={`/shop/${searchTerm}`}>
      ...
      <header className="bg-white py-4 shadow-md px-5 md:hidden mb-5 max-sm:px-0 sticky top-0 w-full z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <Link
              to="/register"
              className="text-white max-sm:text-sm bg-sky-500 px-4 py-2 rounded-md font-medium"
            >
              Register
            </Link>
            <div className="ml-4 relative">
