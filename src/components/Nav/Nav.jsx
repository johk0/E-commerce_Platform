...
export default function Nav() {
			...
			<header className="bg-white py-4 shadow-md px-5 max-md:hidden max-lg:px-4  sticky top-0 w-full z-50">
				<div className="container mx-auto flex justify-between items-center">
					<div className="flex items-center">
						<Link to="/" className="text-2xl font-bold text-sky-500 flex items-center">
	...
	/>
	<button type="submit" className="px-4 py-2 bg-sky-500 text-white rounded-md ml-2">
			...
			{filteredProducts.length ? (
				...
				<div className="px-4 py-2">No results found</div>
					...
					<div className="flex items-center">
						...
						<Link to="/register" className="text-white bg-sky-500 px-4 py-2 rounded-md font-medium">
							Register
						</Link>
			...
			<header className="bg-white py-4 shadow-md px-5 md:hidden mb-5 max-sm:px-0 sticky top-0 w-full z-50">
				<div className="container mx-auto flex justify-between items-center">
					...
					<div className="flex items-center">
						...
						<Link to="/register" className="text-white max-sm:text-sm bg-sky-500 px-4 py-2 rounded-md font-medium">
							Register
						</Link>
						<div className="ml-4 relative">
							<Link to="/cart" className="mr-4 ">
...
>
	...
	{searchTerm && (
		<div className="absolute left-[46%] -translate-x-1/2 mt-1 w-4/5 bg-white border border-gray-300 rounded-md max-h-60 overflow-y-auto custom-scrollbar">
			{filteredProducts.length ? (
				filteredProducts.map((product) => (
					<div key={product.id} className="px-4 py-2 hover:bg-gray-100 ">
						<Link to={`/product/${product.id}`} onClick={() => setSearchTerm("")}>
...
<section className="md:hidden fixed m-auto bottom-3 z-30 left-2/4 -translate-x-1/2 p-2  ">
				...
				<NavLink
					...
					<svg className="w-4 h-4 s" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M36.8 192H603.2c20.3 0 36.8-16.5 36.8-36.8c0-7.3-2.2-14.4-6.2-20.4L558.2 21.4C549.3 8 534.4 0 518.3 0H121.7c-16 0-31 8-39.9 21.4L6.2 134.7c-4 6.1-6.2 13.2-6.2 20.4C0 175.5 16.5 192 36.8 192zM64 224V384v80c0 26.5 21.5 48 48 48H336c26.5 0 48-21.5 48-48V384 224H320V384H128V224H64zm448 0V480c0 17.7 14.3 32 32 32s32-14.3 32-32V224H512z"/></svg>
