...
import { faSearch, faUser, faShoppingCart, faLeaf } from '@fortawesome/free-solid-svg-icons';
...
export default function Nav() {
  ...
  return (
    <>
      <header className="bg-white py-4 shadow-md px-5 max-md:hidden">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <a href="/register" className="text-white bg-blue-500 px-4 py-2 rounded-md font-medium">
              Register
            </a>
            <div className="ml-4">
      ...
      <form className={wantSearch ? "ml-8 flex-grow text-center mt-4 md:hidden" : "ml-8 flex-grow text-center hidden"}>
        <input
          type="text"
          placeholder="Search"
          className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 w-4/5"
      ...
      <section className="md:hidden fixed m-auto bottom-3 z-30 left-2/4 -translate-x-1/2">
        ...
        <label title="notifications" htmlFor="notifications" className="label" >
          <input id="notifications" name="page" type="radio" onClick={handleWantSearch} checked={wantSearch}/>
