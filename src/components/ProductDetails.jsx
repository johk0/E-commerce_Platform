...
export default function ProductDetails({ id }) {
	...
	const item = productsData
		? productsData.find((iterator) => iterator.id === parseInt(id))
		: [];
	console.log(item);
			...
			<div className="grapper flex lg:h-[450px] max-sm:flex-col">
				...
				<div className="text pl-7 w-2/3 max-sm:pt-6 max-sm:w-full max-sm:pl-0">
					...
					<div className="stars py-2">
						<FontAwesomeIcon
							icon={faStar}
							className="text-yellow-400"></FontAwesomeIcon>
						<FontAwesomeIcon
							icon={faStar}
							className="text-yellow-400"></FontAwesomeIcon>
						<FontAwesomeIcon
						...
						<FontAwesomeIcon
							icon={farStar}
							className="text-yellow-400"></FontAwesomeIcon>
						<span className="pl-3 text-neutral-500">
					...
					<div className="colours h-5 flex gap-2 py-3">
						{item.colors ? (
							...
							<>
								<span className="w-5 h-5 rounded-[50%] bg-sky-500 block">
									{" "}
								</span>
								<span className="w-5 h-5 rounded-[50%] bg-teal-700 block">
									{" "}
								</span>
