	...
	return (
		<div className="grapper flex flex-col items-center">
			<div className="head pb-8 text-center">
				<h4 className="text-sky-500 text-xl font-semibold pb-3">
					Practice Advice
				</h4>
			...
			<div className="cards flex justify-center max-lg:flex-col max-lg:gap-6 w-full items-center">
				<div className="card flex pl-2 max-lg:pl-0 max-sm:flex-col">
					<div className="image relative w-1/3 max-sm:w-full max-h-[451px] max-sm:h-64 flex-grow">
						...
						/>
						<p className="absolute top-2 left-2 py-1 px-2 text-white bg-red-500">
							SALE
						</p>
					...
					<div className="text pt-6 pl-6 w-fit">
						...
						<p className="flex flex-col text-neutral-500 pb-2">
							...
							<span>meeting you where you work. Its </span>
							<span>only a keystroke away.</span>
						</p>
						<p className="font-bold text-neutral-500 pb-4">
							<FontAwesomeIcon icon={faDownload} /> 15 Sales
						</p>
						<p className="pb-3">
							<span className="pr-1 text-gray-400 ">$16.48</span>
							<span className="pl-1 text-green-700">$6.48</span>
						</p>
						<div className="colours h-5 flex gap-2">
							...
							<span className="w-5 h-5 rounded-[50%] bg-orange-400 block">
								{" "}
							</span>
						</div>
						...
						<button className="text-sky-500 py-2 px-4 border-2 border-sky-500 rounded-[36px] font-bold">
							Learn More{" "}
