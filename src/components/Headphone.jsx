...
const Headphone=()=>{
    return(
     <div className="grapper md:flex md:items-center md:h-[700px]">
           <section className="relative w-full md:h-1/2 h-auto bg-blue-500 p-6 flex flex-col md:flex-row justify-center items-center rounded-lg">
      <div className="text-center md:text-left mb-4 md:mb-0 pr-4">
        <p className="text-white text-2xl font-bold">40% OFF</p>
        <p className="text-white text-4xl font-extrabold">Sales</p>
      </div>
      ...
      <div className="max-md:text-center md:text-left md:pl-4">
        <p className="text-white text-2xl font-medium">Beats Solo Air</p>
        <p className="text-white text-4xl font-bold">Summer Sale</p>
